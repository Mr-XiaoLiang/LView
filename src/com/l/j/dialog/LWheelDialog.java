...
import com.l.j.R;
import com.l.j.option.LWheelViewOption;
import com.l.j.view.LWheelView;
...
public class LWheelDialog extends Dialog implements LWheelViewListener,android.view.View.OnClickListener {
	/**
	 * 类型
	 */
	...
	public LWheelDialog(Context context, LWheelDialogType type, LWheelViewListener listener) {
		super(context);
		this.type = type;
